...
namespace ChanC
{
    PinOut pMEAS_I_ENRGI(Port::_F, Pin::_1);    // 11
    PinOut pRAZV_ENDU(Port::_C, Pin::_15);      //  9
    PinOut pRAZV_ENRGF(Port::_F, Pin::_0);      // 10
}
...
void HAL_PINS::Init()
{
    ...
    ChanC::pMEAS_I_ENRGI.Init();
    ChanC::pRAZV_ENDU.Init();
    ChanC::pRAZV_ENRGF.Init();
}
