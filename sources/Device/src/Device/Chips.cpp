...
{   //      cs                  clk         dat
    ...
    { 12, &ChanC::pRAZV_ENDU, &pCLK2_DAC, &pDAT2_DAC },  // 1 Канал C. Диапазон
...
ChipREG regs[10] =
{
    ...
    { 32, &ChanC::pRAZV_ENRGF,   &pCLK2_DAC, &pDAT2_DAC },  // 2 Канал C
    { 32, &pB_ENRGB,             &pCLK1_DAC, &pDAT1_DAC },  // 3 Канал B
    { 32, &pS_ENRGP,             &pCLK1_DAC, &pDAT1_DAC },  // 4 Канал S
    { 16, &ChanC::pMEAS_I_ENRGI, &pCLK2_DAC, &pDAT2_DAC },  // 5 Измеритель тока
    { 0,  nullptr,               nullptr,    nullptr },
    { 0,  nullptr,               nullptr,    nullptr },
    { 0,  nullptr,               nullptr,    nullptr },
    { 0,  nullptr,               nullptr,    nullptr }
